...
class StrackOverlayWidget(QtWidgets.QWidget):
    """
    ...
    def __init__(self, parent, style="dark"):
        ...
        self.bg_color = self.BG_COLOR_MAP.get(style, "#1b1b1b")
        ...
        self._message = None
        self._st_icon = QtGui.QPixmap(":/icons/strack_loading.png")
    ...
    def paintEvent(self, event):
        ...
        try:
            ...
            overlay_color = QtGui.QColor(self.bg_color)
            ...
            if self._mode == self.MODE_SPIN:
                ...
                pen = QtGui.QPen(QtGui.QColor("#58b7ff"))
                pen.setWidth(3)
                painter.setPen(pen)
                painter.drawPixmap(QtCore.QPoint(13, 13), self._st_icon)

                r = QtCore.QRectF(0.0, 0.0, 90.0, 90.0)
